    ...
    def _build_model(self, **kwargs):
        ...
        with tf.variable_scope('layer1'):
            d['conv1'] = conv_layer(X_input, 3, 1, 32,
                                    padding='SAME', use_bias=False, weights_stddev=0.01, name='Conv2D:0')
            d['batch_norm1'] = batchNormalization(d['conv1'], is_train,'norm1')
            d['leaky_relu1'] = tf.nn.leaky_relu(d['batch_norm1'], alpha=0.1, name='leaky_relu1_output')
        ...
        with tf.variable_scope('layer2'):
            ...
            d['batch_norm2'] = batchNormalization(d['conv2'], is_train,'norm2')
            d['leaky_relu2'] = tf.nn.leaky_relu(d['batch_norm2'], alpha=0.1, name='leaky_relu2_output')
        ...
        with tf.variable_scope('layer3'):
            ...
            d['batch_norm3'] = batchNormalization(d['conv3'], is_train,'norm3')
            d['leaky_relu3'] = tf.nn.leaky_relu(d['batch_norm3'], alpha=0.1, name='leaky_relu3_output')
        ...
        with tf.variable_scope('layer4'):
            ...
            d['batch_norm4'] = batchNormalization(d['conv4'], is_train,'norm4')
            d['leaky_relu4'] = tf.nn.leaky_relu(d['batch_norm4'], alpha=0.1, name='leaky_relu4_output')
        ...
        with tf.variable_scope('layer5'):
            ...
            d['batch_norm5'] = batchNormalization(d['conv5'], is_train,'norm5')
            d['leaky_relu5'] = tf.nn.leaky_relu(d['batch_norm5'], alpha=0.1, name='leaky_relu5_output')
        ...
        with tf.variable_scope('layer6'):
            ...
            d['batch_norm6'] = batchNormalization(d['conv6'], is_train,'norm6')
            d['leaky_relu6'] = tf.nn.leaky_relu(d['batch_norm6'], alpha=0.1, name='leaky_relu6_output')
        # (52, 52, 128) --> (52, 52, 256)
        ...
        with tf.variable_scope('layer7'):
            d['conv7'] = conv_layer(d['leaky_relu6'], 1, 1, 128,
                                    padding='SAME', weights_stddev=0.01, biases_value=0.0, name='Conv2D:7')
            d['batch_norm7'] = batchNormalization(d['conv7'], is_train,'norm7')
            d['leaky_relu7'] = tf.nn.leaky_relu(d['batch_norm7'], alpha=0.1, name='leaky_relu7_output')
        # (52, 52, 256) --> (52, 52, 128)
        ...
        with tf.variable_scope('layer8'):
            ...
            d['batch_norm8'] = batchNormalization(d['conv8'], is_train,'norm8')
            d['leaky_relu8'] = tf.nn.leaky_relu(d['batch_norm8'], alpha=0.1, name='leaky_relu8_output')
        ...
        with tf.variable_scope('layer9'):
            ...
            d['batch_norm9'] = batchNormalization(d['conv9'], is_train,'norm9')
            d['leaky_relu9'] = tf.nn.leaky_relu(d['batch_norm9'], alpha=0.1, name='leaky_relu9_output')
        # (26, 26, 256) --> (26, 26, 512)
        ...
        with tf.variable_scope('layer10'):
            ...
            d['batch_norm10'] = batchNormalization(d['conv10'], is_train,'norm10')
            d['leaky_relu10'] = tf.nn.leaky_relu(d['batch_norm10'], alpha=0.1, name='leaky_relu10_output')
        # (26, 26, 512) --> (26, 26, 256)
        ...
        with tf.variable_scope('layer11'):
            ...
            d['batch_norm11'] = batchNormalization(d['conv11'], is_train,'norm11')
            d['leaky_relu11'] = tf.nn.leaky_relu(d['batch_norm11'], alpha=0.1, name='leaky_relu11_output')
        # (26, 26, 256) --> (26, 26, 512)
        ...
        with tf.variable_scope('layer12'):
            ...
            d['batch_norm12'] = batchNormalization(d['conv12'], is_train,'norm12')
            d['leaky_relu12'] = tf.nn.leaky_relu(d['batch_norm12'], alpha=0.1, name='leaky_relu12_output')
        # (26, 26, 512) --> (26, 26, 256)
        ...
        with tf.variable_scope('layer13'):
            ...
            d['batch_norm13'] = batchNormalization(d['conv13'], is_train,'norm13')
            d['leaky_relu13'] = tf.nn.leaky_relu(d['batch_norm13'], alpha=0.1, name='leaky_relu13_output')
        ...
        with tf.variable_scope('layer14'):
            ...
            d['batch_norm14'] = batchNormalization(d['conv14'], is_train,'norm14')
            d['leaky_relu14'] = tf.nn.leaky_relu(d['batch_norm14'], alpha=0.1, name='leaky_relu14_output')
        ...
        with tf.variable_scope('layer15'):
            ...
            d['batch_norm15'] = batchNormalization(d['conv15'], is_train,'norm15')
            d['leaky_relu15'] = tf.nn.leaky_relu(d['batch_norm15'], alpha=0.1, name='leaky_relu15_output')
        ...
        with tf.variable_scope('layer16'):
            ...
            d['batch_norm16'] = batchNormalization(d['conv16'], is_train,'norm16')
            d['leaky_relu16'] = tf.nn.leaky_relu(d['batch_norm16'], alpha=0.1, name='leaky_relu16_output')
        # (13, 13, 512) --> (13, 13, 1024)
        ...
        with tf.variable_scope('layer17'):
            ...
            d['batch_norm17'] = batchNormalization(d['conv17'], is_train,'norm17')
            d['leaky_relu17'] = tf.nn.leaky_relu(d['batch_norm17'], alpha=0.1, name='leaky_relu17_output')
        # (13, 13, 1024) --> (13, 13, 512)
        ...
        with tf.variable_scope('layer18'):
            ...
            d['batch_norm18'] = batchNormalization(d['conv18'], is_train,'norm18')
            d['leaky_relu18'] = tf.nn.leaky_relu(d['batch_norm18'], alpha=0.1, name='leaky_relu18_output')
        # (13, 13, 512) --> (13, 13, 1024)
        ...
        with tf.variable_scope('layer19'):
            ...
            d['batch_norm19'] = batchNormalization(d['conv19'], is_train,'norm19')
            d['leaky_relu19'] = tf.nn.leaky_relu(d['batch_norm19'], alpha=0.1, name='leaky_relu19_output')
        ...
        with tf.variable_scope('layer20'):
            ...
            d['batch_norm20'] = batchNormalization(d['conv20'], is_train,'norm20')
            d['leaky_relu20'] = tf.nn.leaky_relu(d['batch_norm20'], alpha=0.1, name='leaky_relu20_output')
        # (13, 13, 1024) --> (13, 13, 1024)
        ...
        with tf.variable_scope('layer21'):
            ...
            d['skip_batch'] = batchNormalization(
                d['skip_connection'], is_train,'norm21')
            d['skip_leaky_relu'] = tf.nn.leaky_relu(d['skip_batch'], alpha=0.1, name='leaky_relu21_output')
        ...
        with tf.variable_scope('layer22'):
            ...
            d['batch_norm22'] = batchNormalization(d['conv22'], is_train,'norm22')
            d['leaky_relu22'] = tf.nn.leaky_relu(d['batch_norm22'], alpha=0.1, name='leaky_relu22_output')
