...
from model.mobilenet import depthwise_separable_convolution
...
class SSD(object):
    ...
    def make_model(self):
        ...
        if self.backbone == 'Mobilenet_v1':
            ...
            backbone_model = Mobilenet(self.input_shape, self.num_classes)
            ...
            x = depthwise_separable_convolution(outputs, 1024, strides=(2, 1))
            x = depthwise_separable_convolution(x, 1024, strides=(1, 1))
            ...
            return Model(inputs=inputs, outputs=z_concat)
