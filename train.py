...
import Training.SSDLoss_new as SSDLoss
import Model.MobileNetSSD_model as MobileNetSSD
import json
from keras.callbacks import LambdaCallback, CSVLogger, ModelCheckpoint, ReduceLROnPlateau
from Util.ssd_utils import BBoxUtility
...
with train_graph.as_default():
    ...
    # make model
    model = MobileNetSSD.MobileNetSSD(input_shape, NUM_CLASSES)
    
    train_model = model.build_keras_model()
